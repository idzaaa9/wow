...
public:
  ...
  item( itemType itemTypeRef, itemQuality itemQualityRef, unsigned short stackSizeRef, const int &valueRef,  bool soulboundRef,const DinString& NameRef) : stackSize(stackSizeRef), Value(valueRef), Soulbound(soulboundRef), ItemName(NameRef), Type(itemTypeRef), Quality(itemQualityRef) {}
